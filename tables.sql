...
CREATE TABLE species (
    ...
    s_order string(100) not null,
    s_family string(100) not null,
    s_occurrence string(100) not null,
    s_nativeness string(100) not null,
    s_abundance string(100) not null,
    s_seasonality string(100) not null
);
...
CREATE TABLE animals (
    ...
    a_conservation_ststus string(100) not null
);
...
CREATE TABLE plants (
    ...
    pl_conservation_status string(100) not null
);
